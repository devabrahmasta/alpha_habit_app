...
import 'package:alpha/core/services/firebase_auth_service.dart';
...
final targetRepoProvider = Provider<TargetRepository>(
  (_) => TargetRepository.instance,
);

// ──────────────────────────────────────────────
//  AUTH  (Firebase User stream)
// ──────────────────────────────────────────────
